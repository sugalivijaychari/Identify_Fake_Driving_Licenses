...
Fig. 1.1: Variance in networks [2]
...
Fig. 1.3: Potential applications of Blockchain Technology [2]
...
Fig. 2.1: News of Times of India showing Gang arrested in making fake ID Cards [3]
...
Fig. 2.3: News showing that smuggling luxury vehicles become a trend now overwhelming gold [5]
...
* Meeseva portal is maintained in SQL server. Click here [6] to view details or explore apps.nic.in.
* RTO portal is maintained in application server TOMCAT. Click here [7] to view details or explore apps.nic.in.
...
Fig. 3.1: Data accessibility in Meeseva portal [8]

RTO portal authorization to control driving license data [9]:
...
* Each member or officer in these governing bodies are added or removed by the approval of remaining members of that governing body. This fulfills the need of decentralized power.
* Each governing body is added or removed by a head governing body.
* That means the governing bodies like RTO, Meeseva, Traffic management department are added in this decentralized eco-system by head governing body.
...
* In this eco-system every activity done by every officer is recorded permanently in ledger.
...
* Hence, every citizens personal and vehicle details are stored in our eco-system.
* Now, traffic management department, one of the governing bodies in our eco-system can check for details of a citizen whether a particular person details are correct with particular vehicle details.
...
* Etherscan verification address: Click here [16] to view or explore Etherscan.io.
